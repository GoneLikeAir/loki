...
type Config struct {
	...
	ReadSizeLimit        float64 `mapstructure:"read_size_limit" yaml:"read_size_limit" json:"read_size_limit"`
	ReadSizeBurst        int     `mapstructure:"read_size_burst" yaml:"read_size_burst" json:"read_size_burst"`
	ReadSizeLimitEnabled bool    `mapstructure:"read_size_limit_enabled,omitempty" yaml:"read_size_limit_enabled,omitempty"  json:"read_size_limit_enabled"`
	...
	ReadSizeLimitDrop    bool    `mapstructure:"read_size_limit_drop,omitempty" yaml:"read_size_limit_drop,omitempty"  json:"read_size_limit_drop"`
...
func (cfg *Config) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.Float64Var(&cfg.ReadSizeLimit, prefix+"limit.read-size-limit", 10, "The size limit in reading log size(unit: MB) per second that the instance of Promtail may push to loki.")
	f.IntVar(&cfg.ReadSizeBurst, prefix+"limit.read-size-burst", 10, "The cap in the quantity of burst size that this instance of Promtail may push to Loki.")
	...
	f.BoolVar(&cfg.ReadSizeLimitEnabled, prefix+"limit.read-size-limit-enabled", false, "When true, enforces size limiting on this instance of Promtail.")
	...
	f.BoolVar(&cfg.ReadSizeLimitDrop, prefix+"limit.read-size-limit-drop", true, "When true, exceeding the size limit causes this instance of Promtail to discard log lines, rather than sending them to Loki.")

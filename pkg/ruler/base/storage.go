...
import (
	...
	configClient "github.com/GoneLikeAir/loki/pkg/configs/client"
	"github.com/GoneLikeAir/loki/pkg/ruler/rulestore"
	"github.com/GoneLikeAir/loki/pkg/ruler/rulestore/bucketclient"
	"github.com/GoneLikeAir/loki/pkg/ruler/rulestore/configdb"
	"github.com/GoneLikeAir/loki/pkg/ruler/rulestore/local"
	"github.com/GoneLikeAir/loki/pkg/ruler/rulestore/objectclient"
	"github.com/GoneLikeAir/loki/pkg/storage"
	"github.com/GoneLikeAir/loki/pkg/storage/bucket"
	"github.com/GoneLikeAir/loki/pkg/storage/chunk/client"
	"github.com/GoneLikeAir/loki/pkg/storage/chunk/client/aws"
	"github.com/GoneLikeAir/loki/pkg/storage/chunk/client/azure"
	"github.com/GoneLikeAir/loki/pkg/storage/chunk/client/baidubce"
	"github.com/GoneLikeAir/loki/pkg/storage/chunk/client/gcp"
	"github.com/GoneLikeAir/loki/pkg/storage/chunk/client/hedging"
	"github.com/GoneLikeAir/loki/pkg/storage/chunk/client/openstack"
)
